...
import {
  ...
  getActividadesByIngresoService,
...
export const getActividad = async (req, res) => {
  try {
    const [actividad, errorActividad] = await getActividadService(
      req.params.id
    );
...
export const getActividadesByIngreso = async (req, res) => {
  try {
    const [actividades, errorActividades] =
      await getActividadesByIngresoService(req.params.id);
