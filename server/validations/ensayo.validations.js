...
export const ensayoBodyValidation = Joi.object({
    actividad: Joi.string()
        ...
        .messages({
            ...
            "string.pattern.base": "La actividad debe contener al menos una letra y solo puede incluir letras, números, espacios y algunos caracteres especiales como .,;:!?-."
        }),
    area: Joi.string()
        .max(30)
        .pattern(/^[a-zA-Z0-9-ZáéíóúÁÉÍÓÚñÑ\s.,;:!?-]+$/)
        ...
        .messages({
            ...
            "string.pattern.base": "El área debe contener al menos una letra y solo puede incluir letras, números, espacios y algunos caracteres especiales como .,;:!?-."
        }),
    unidad: Joi.string()
        .min(1)
        .max(3)
        ...
        .messages({
            ...
            "string.pattern.base": "La unidad debe contener al menos una letra y solo puede incluir letras, números, espacios y algunos caracteres especiales como .,;:!?-."
        }),
    precio_uf: Joi.number()
        .min(0)
        .max(1000000)
        .messages({
